...
"""
__version__ = "$Revision: 550 $, $Date: 2014-10-24 16:47:53 +0200 (vr, 24 okt 2014) $, $Author: quintijn $"
...
class BringupTest(UnimacroTestHelpers.UnimacroTestHelpers):
    ...
    def setUp(self):
        ...
        self.startUser, dummy = natlink.getCurrentUser()

    def tearDown(self):
        endUser, dummy = natlink.getCurrentUser()
