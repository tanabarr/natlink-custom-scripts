...
"""
__version__ = "$Rev: 399 $ on $Date: 2011-03-07 15:01:08 +0100 (ma, 07 mrt 2011) $ by $Author: quintijn $"
...
<alltests> exported = unimacro test (all);
    ...
    def getTestNames(self):
        ...
        """
        self.testFolder = os.path.join(natqh.getUserDirectory(), "unimacro_test")
