...
unimacroDirectory = status.getOriginalUnimacroDirectory().lower()
...
#    print """
#
#-------Cannot find a valid "spokenforms.ini" configuraton file
#
#This file is expected and needed in the
#UnimacroUserDirectory (%s) in order
#to let the Unimacro numbers lists work with spoken forms.
#
...
#
#Please find and edit your spokenforms.ini file if you want to use this feature
#---------
#
#
#"""% (userDirectory, baseDirectory, sampleDirectories)
#    time.sleep(0.2)
#    raise ActionError('no inifile found for numbers spoken forms in unimacro or sample_ini')
