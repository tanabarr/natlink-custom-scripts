...
SelectDirBrowseLabel=To continue, click Next. If you would like to select a different folder, click Browse.%n%nAdvice (Vista, Windows 7): DO NOT INSTALL in "C:\Program Files" or in another folder which may have restricted rights for creating and changing user files.
