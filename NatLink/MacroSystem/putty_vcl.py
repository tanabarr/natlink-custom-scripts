...
class ThisGrammar(GrammarBase):
    ...
    gramSpec = """
        ...
        <324> = ('pool' | 'she said' ) ('history' | 'status' | 'list' | 'destroy' | 'create' ) ;
        <245> = 'pool' ('import' | 'export' ) ('go' ) ;
        <326> = 'pool' ('import' | 'export' ) ;
        <325> = 'pool' ('go' ) ;
        <327> = 'pool' ;
