...
class ThisGrammar(GrammarBase):
    ...
    gramSpec = """
        ...
        <256> = ('pool' | 'she said' ) ('history' | 'status' | 'list' | 'destroy' | 'create' ) ;
        <190> = 'pool' ('import' | 'export' ) ('go' ) ;
        <258> = 'pool' ('import' | 'export' ) ;
        <257> = 'pool' ('go' ) ;
        <259> = 'pool' ;
