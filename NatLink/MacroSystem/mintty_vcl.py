...
class ThisGrammar(GrammarBase):
    ...
    gramSpec = """
        ...
        <311> = ('pool' | 'she said' ) ('history' | 'status' | 'list' | 'destroy' | 'create' ) ;
        <238> = 'pool' ('import' | 'export' ) ('go' ) ;
        <313> = 'pool' ('import' | 'export' ) ;
        <312> = 'pool' ('go' ) ;
        <314> = 'pool' ;
