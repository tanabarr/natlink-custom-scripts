...
class ThisGrammar(GrammarBase):
    ...
    gramSpec = """
        ...
        <312> = ('pool' | 'she said' ) ('history' | 'status' | 'list' | 'destroy' | 'create' ) ;
        <238> = 'pool' ('import' | 'export' ) ('go' ) ;
        <314> = 'pool' ('import' | 'export' ) ;
        <313> = 'pool' ('go' ) ;
        <315> = 'pool' ;
    ...
    def gotResults_153(self, words, fullResults):
        ...
        try:
            ...
            handle_error('screen.vch', 16, '\'screen switch\' 0..9', e)
            self.firstWord = -1
