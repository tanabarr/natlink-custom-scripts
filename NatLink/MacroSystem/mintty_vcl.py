...
class ThisGrammar(GrammarBase):
    ...
    gramSpec = """
        ...
        <313> = ('pool' | 'she said' ) ('history' | 'status' | 'list' | 'destroy' | 'create' ) ;
        <238> = 'pool' ('import' | 'export' ) ('go' ) ;
        <315> = 'pool' ('import' | 'export' ) ;
        <314> = 'pool' ('go' ) ;
        <316> = 'pool' ;
