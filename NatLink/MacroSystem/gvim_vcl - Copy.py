...
# coding: latin-1
# Generated by vcl2py 2.8.6, Thu Sep 07 14:04:35 2017
...
class ThisGrammar(GrammarBase):
    ...
    gramSpec = """
        ...
        <117> = ('Change' | 'Copy' ) 'Back' ;
        <4> = ('Change' | 'Copy' ) <4b> ;
        <4b> = <1to30> 'Chars' ;
        <118> = ('Change' | 'Copy' ) <1to30> ;
        <5> = ('Change' | 'Copy' ) 'Back' <5b> ;
        <5b> = <1to30> 'Chars' ;
        <119> = ('Change' | 'Copy' ) 'Back' <1to30> ;
        <6> = 'Kill' ('Char' | '1' | 'One' ) ;
        <7> = 'Kill Back 1' ;
        <120> = 'Kill Back' ;
        <8> = 'Kill' <8b> ;
        ...
        <124> = 'Change case' ('back' ) ;
        <123> = 'Change case' <1to30> ;
        <125> = 'Change case' ;
        <11> = 'One Word' ;
        <126> = 'Word' ;
        <12> = 'Back One Word' ;
        ...
        <128> = <line_actions> 'Line' ;
        <21> = 'Swap' ('Line' | 'Char' ) ;
        <22> = 'Swap back' ('Line' | 'Char' ) ;
        <23> = <edit_mode> ('Beginning' | 'Start' | 'End' ) 'Line Here' ;
        <130> = <edit_mode> ('Beginning' | 'Start' | 'End' ) 'Line' ;
        <129> = <edit_mode> ('Beginning' | 'Start' | 'End' ) 'Here' ;
        <131> = <edit_mode> ('Beginning' | 'Start' | 'End' ) ;
        <24> = 'Blank' ('back' | 'insert' ) 'Line' ;
        <132> = 'Blank' ('back' | 'insert' ) ;
        <25> = 'Join' ('Back' | 'Next' ) 'Line' ;
        <134> = 'Join' ('Back' | 'Next' ) ;
        <133> = 'Join Line' ;
        <135> = 'Join' ;
        <relative_range_actions> = ('Change' | 'Kill' | 'Copy' | 'Move to' | 'Copy to' | 'duplicate' ) ;
        ...
        <relative_range_commands> = ('Sub' | 'Start' | 'Append' | 'copy here' | 'comment' | 'remove comment' | 'pie comment' | 'remove pie comment' | 'indent' | 'reverse indent' ) ;
        ...
        <range_actions> = ('Move to' | 'Copy to' | 'Change' | 'Kill' | 'Copy' | 'Sub' | 'copy here' | 'comment' | 'remove comment' | 'copy here' | 'pie comment' | 'remove pie comment' ) ;
        <32> = <range_actions> 'Range' ;
        <insert> = ('insert' | 'append' ) ;
        <33> = 'Flow' ('Start' | 'Append' ) <insert> ;
        <136> = 'Flow' ('Start' | 'Append' ) ;
        <34> = <edit_mode> ('Flow Here' | 'Flow All' | 'Back Flow Here' ) ;
        <sub_action> = ('all' | 'here' | 'back here' ) ;
        <35> = ('sub' | 'substitute' ) <sub_action> ;
        <36> = ('edit' | 'editor' ) ('cancel' | 'redo' ) <2to9> ;
        <137> = ('edit' | 'editor' ) ('cancel' | 'redo' ) ;
        <37> = ('change' ) ('inner' | 'outer' ) ('brackets' | 'braces' | 'square brackets' | 'doc string' | 'quotes' ) ;
        <38> = 'Start macro' ;
        <39> = 'Repeat macro' (1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9) 'times' ;
        <138> = 'Repeat macro' ;
        <text_actions> = ('Paste' | 'Paste Back' | 'Insert' | 'Append here' | 'Append' | 'Substitute' | 'Replace' | 'difference push over' | 'difference pull over' | 'difference next' | 'difference back' | 'Format' | 'Normal mode' | 'visual mode' ) ;
        <40> = (('Paste' | 'Paste Back' | 'Insert' | 'Append here' | 'Append' | 'Substitute' | 'Replace' | 'difference push over' | 'difference pull over' | 'difference next' | 'difference back' | 'Format' | 'Normal mode' | 'visual mode' ) ) ;
        ...
        <41> = 'line' <line_mod> <0to9> ;
        <142> = 'line' <0to9> ;
        <42> = 'line' <line_mod> <0to9> <0to9> ;
        <143> = 'line' <0to9> <0to9> ;
        <43> = 'line' <line_mod> <0to9> <0to9> <0to9> ;
        <144> = 'line' <0to9> <0to9> <0to9> ;
        <44> = 'line' <line_mod> <0to9> <0to9> <0to9> <0to9> ;
        <145> = 'line' <0to9> <0to9> <0to9> <0to9> ;
        ...
        <45> = (('List changes' | 'back change' | 'Undo jump' | 'return from' | 'Set mark' | 'Goto mark' | 'Append back' | 'Append next' | 'Start back' | 'Start next' | 'Match bracket' | 'Scroll to bottom' | 'Scroll bottom' | 'Scroll to top' | 'Scroll top' | 'Scroll to middle' | 'Scroll middle' ) ) ;
        <46> = 'Halfpage' ('Up' | 'Down' ) ;
        <149> = 'Halfpage' ;
        <47> = 'Page' <top_bottom> ;
        <48> = 'leap back' <48b> ;
        <48b> = <printable> (1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9) ;
        <150> = 'leap back' <printable> ;
        <49> = 'leap' <49b> ;
        <49b> = <printable> (1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9) ;
        <151> = 'leap' <printable> ;
        <50> = 'leap before' <50b> ;
        <50b> = <printable> (1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9) ;
        <152> = 'leap before' <printable> ;
        <51> = 'leap back cap' <51b> ;
        <51b> = <printable> (1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9) ;
        <153> = 'leap back cap' <printable> ;
        <52> = 'leap cap' <52b> ;
        <52b> = <printable> (1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9) ;
        <154> = 'leap cap' <printable> ;
        <53> = 'leap before cap' <53b> ;
        <53b> = <printable> (1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9) ;
        <155> = 'leap before cap' <printable> ;
        <54> = 'leap next' ;
        <55> = 'leap combo' <printable> <printable> <printable> <printable> ;
        <157> = 'leap combo' <printable> <printable> <printable> ;
        <156> = 'leap combo' <printable> <printable> ;
        <56> = 'Search' <dgndictation> ;
        <57> = 'Search go' <dgndictation> ;
        <58> = 'clear Search' ;
        <59> = 'shell command' ;
        <60> = 'Make' ;
        <61> = 'Vim Update Tag File' ;
        <62> = 'List errors' ;
        <63> = 'Next error' ;
        <64> = 'back error' ;
        <65> = ('Save' | 'Close' | 'save and close' ) 'file' ('confirm' ) ;
        <158> = ('Save' | 'Close' | 'save and close' ) 'file' ;
        <66> = 'back command' (1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9) ;
        <159> = 'back command' ;
        <67> = 'Edit another' ;
        <68> = 'File browser' ;
        <69> = 'vim diff split' ;
        ...
        <75> = 'insert comment' ;
        <76> = ('open' | 'close' ) 'doc string' ;
        <77> = 'Double slash backslash' ;
        <78> = 'reference' ;
        <79> = 'Function definition' ;
        <80> = 'Function definition' <dgndictation> ;
        <81> = 'Show Help' ;
        <82> = 'Set setting' ('paste' ) ;
        <160> = 'Set setting' ;
        <83> = 'Set dark background' ;
        <84> = 'Set light background' ;
        <85> = 'reload vim config' ;
        <86> = 'run this' ('now' ) ;
        <161> = 'run this' ;
        <87> = 'Split vertical' ;
        <window_action> = ('left' | 'right' | 'up' | 'down' | 'next' | 'close' ) ;
        <88> = 'Vim Window' <window_action> ;
        <89> = 'Vim Window crop' ;
        <90> = 'Vim Window make fat' ;
        <91> = 'Vim Window make thin' ;
        <buffer_action> = ('back' | 'close' | 'next' | 'switch' | 'list' ) ;
        <92> = 'via buffer' <buffer_action> ;
        <93> = 'via buffer number' <1to30> ;
        <tab_actions> = ('back' | 'Close' | 'Next' | 'List' | 'Last' | 'First' ) ;
        <94> = 'vim page' <tab_actions> ;
        <95> = 'vim page switch' <1to30> ;
        <96> = 'vim Tags back' ;
        <97> = 'vim Tags Jump' ;
        <98> = 'vim Tags Next' ;
        <99> = 'Vim Tags Match' ;
        ...
        <105> = 'Reload' ;
        <106> = 'all buffers' ;
        <107> = 'show file details' ;
        <108> = 'command history' ;
        <109> = 'pattern match history' ;
        <110> = 'histogram debug' ;
        <111> = 'ifdef' ('debug' | 'trace' ) ;
        <112> = 'ifdef end' ;
        ...
        <115> = 'file save as' ;
        <116> = 'file save' ;
        <any> = <1>|<2>|<3>|<117>|<4>|<118>|<5>|<119>|<6>|<7>|<120>|<8>|<121>|<9>|<122>|<10>|<124>|<123>|<125>|<11>|<126>|<12>|<127>|<13>|<14>|<15>|<16>|<17>|<18>|<19>|<20>|<128>|<21>|<22>|<23>|<130>|<129>|<131>|<24>|<132>|<25>|<134>|<133>|<135>|<26>|<27>|<28>|<29>|<30>|<31>|<32>|<33>|<136>|<34>|<35>|<36>|<137>|<37>|<38>|<39>|<138>|<40>|<41>|<142>|<42>|<143>|<43>|<144>|<44>|<145>|<45>|<46>|<149>|<47>|<48>|<150>|<49>|<151>|<50>|<152>|<51>|<153>|<52>|<154>|<53>|<155>|<54>|<55>|<157>|<156>|<56>|<57>|<58>|<59>|<60>|<61>|<62>|<63>|<64>|<65>|<158>|<66>|<159>|<67>|<68>|<69>|<70>|<71>|<72>|<73>|<74>|<75>|<76>|<77>|<78>|<79>|<80>|<81>|<82>|<160>|<83>|<84>|<85>|<86>|<161>|<87>|<88>|<89>|<90>|<91>|<92>|<93>|<94>|<95>|<96>|<97>|<98>|<99>|<100>|<101>|<102>|<103>|<104>|<105>|<106>|<107>|<108>|<109>|<110>|<111>|<112>|<113>|<114>|<115>|<116>;
    ...
    def gotResults_1(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 29, '(1..30) <direction>', e)
            self.firstWord = -1
    ...
    def gotResults_2(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 30, '(\'Change\' | \'Copy\') (\'Char\' | \'1\' | \'One\')', e)
            self.firstWord = -1
    ...
    def gotResults_3(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 31, '(\'Change\' | \'Copy\') \'Back 1\'', e)
            self.firstWord = -1
    ...
    def gotResults_117(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 31, '(\'Change\' | \'Copy\') \'Back\'', e)
            self.firstWord = -1
    ...
    def gotResults_4(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 32, '(\'Change\' | \'Copy\') <1to30> \'Chars\'', e)
            self.firstWord = -1
    ...
    def gotResults_118(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 32, '(\'Change\' | \'Copy\') <1to30>', e)
            self.firstWord = -1
    ...
    def gotResults_5(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 33, '(\'Change\' | \'Copy\') \'Back\' <1to30> \'Chars\'', e)
            self.firstWord = -1
    ...
    def gotResults_119(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 33, '(\'Change\' | \'Copy\') \'Back\' <1to30>', e)
            self.firstWord = -1
    ...
    def gotResults_6(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 34, '\'Kill\' (\'Char\' | \'1\' | \'One\')', e)
            self.firstWord = -1
    ...
    def gotResults_7(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 35, '\'Kill Back 1\'', e)
            self.firstWord = -1
    ...
    def gotResults_120(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 35, '\'Kill Back\'', e)
            self.firstWord = -1
    ...
    def gotResults_8(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 36, '\'Kill\' <1to30> \'Chars\'', e)
            self.firstWord = -1
    ...
    def gotResults_121(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 36, '\'Kill\' <1to30>', e)
            self.firstWord = -1
    ...
    def gotResults_9(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 37, '\'Kill Back\' <1to30> \'Chars\'', e)
            self.firstWord = -1
    ...
    def gotResults_122(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 37, '\'Kill Back\' <1to30>', e)
            self.firstWord = -1
    ...
    def gotResults_10(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 38, '\'Change case\' (\'back\') <1to30>', e)
            self.firstWord = -1
    ...
    def gotResults_124(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 38, '\'Change case\' (\'back\')', e)
            self.firstWord = -1
    ...
    def gotResults_123(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 38, '\'Change case\' <1to30>', e)
            self.firstWord = -1
    ...
    def gotResults_125(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 38, '\'Change case\'', e)
            self.firstWord = -1
    ...
    def gotResults_20(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 61, '<line_actions> \'this Line\'', e)
            self.firstWord = -1
    ...
    def gotResults_128(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 61, '<line_actions> \'Line\'', e)
            self.firstWord = -1
    ...
    def gotResults_21(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 63, '\'Swap\' (\'Line\' | \'Char\')', e)
            self.firstWord = -1
    ...
    def gotResults_22(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 64, '\'Swap back\' (\'Line\' | \'Char\')', e)
            self.firstWord = -1
    ...
    def gotResults_23(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 66, '<edit_mode> (\'Beginning\' | \'Start\' | \'End\') \'Line Here\'', e)
            self.firstWord = -1
    ...
    def gotResults_130(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 66, '<edit_mode> (\'Beginning\' | \'Start\' | \'End\') \'Line\'', e)
            self.firstWord = -1
    ...
    def gotResults_129(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 66, '<edit_mode> (\'Beginning\' | \'Start\' | \'End\') \'Here\'', e)
            self.firstWord = -1
    ...
    def gotResults_131(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 66, '<edit_mode> (\'Beginning\' | \'Start\' | \'End\')', e)
            self.firstWord = -1
    ...
    def gotResults_24(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 67, '\'Blank\' (\'back\' | \'insert\') \'Line\'', e)
            self.firstWord = -1
    ...
    def gotResults_132(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 67, '\'Blank\' (\'back\' | \'insert\')', e)
            self.firstWord = -1
    ...
    def gotResults_25(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 68, '\'Join\' (\'Back\' | \'Next\') \'Line\'', e)
            self.firstWord = -1
    ...
    def gotResults_134(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 68, '\'Join\' (\'Back\' | \'Next\')', e)
            self.firstWord = -1
    ...
    def gotResults_133(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 68, '\'Join Line\'', e)
            self.firstWord = -1
    ...
    def gotResults_135(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 68, '\'Join\'', e)
            self.firstWord = -1
    ...
    def gotResults_26(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 80, '<relative_range_actions> (\'Next\' | \'Back\') \'Line\'', e)
            self.firstWord = -1
    ...
    def gotResults_27(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 81, '<relative_range_actions> 2..30 \'Lines\'', e)
            self.firstWord = -1
    ...
    def gotResults_28(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 82, '<relative_range_actions> \'Back\' 2..30 \'Lines\'', e)
            self.firstWord = -1
    ...
    def get_relative_range_commands(self, list_buffer, functional, word):
        if word == 'Sub':
            ...
            list_buffer += 's/\\/\\///{enter}'
        elif word == 'pie comment':
            list_buffer += 's/^/#/{enter}'
        elif word == 'remove pie comment':
            list_buffer += 's/#//{enter}'
        elif word == 'indent':
            list_buffer += '>{enter}'
    ...
    def gotResults_29(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 90, '<relative_range_commands> (\'Next\' | \'Back\') \'Line\'', e)
            self.firstWord = -1
    ...
    def gotResults_30(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 91, '<relative_range_commands> 2..30 \'Lines\'', e)
            self.firstWord = -1
    ...
    def gotResults_31(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 92, '<relative_range_commands> \'Back\' 2..30 \'Lines\'', e)
            self.firstWord = -1
    ...
    def gotResults_32(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 100, '<range_actions> \'Range\'', e)
            self.firstWord = -1
    ...
    def gotResults_33(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 104, '\'Flow\' (\'Start\' | \'Append\') <insert>', e)
            self.firstWord = -1
    ...
    def gotResults_136(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 104, '\'Flow\' (\'Start\' | \'Append\')', e)
            self.firstWord = -1
    ...
    def gotResults_34(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 105, '<edit_mode> (\'Flow Here\' | \'Flow All\' | \'Back Flow Here\')', e)
            self.firstWord = -1
    ...
    def gotResults_35(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 111, '(\'sub\' | \'substitute\') <sub_action>', e)
            self.firstWord = -1
    ...
    def gotResults_36(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 115, '(\'edit\' | \'editor\') (\'cancel\' | \'redo\') <2to9>', e)
            self.firstWord = -1
    ...
    def gotResults_137(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 115, '(\'edit\' | \'editor\') (\'cancel\' | \'redo\')', e)
            self.firstWord = -1
    ...
    def gotResults_37(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 123, '(\'change\') (\'inner\' | \'outer\') (\'brackets\' | \'braces\' | \'square brackets\' | \'doc string\' | \'quotes\')', e)
            self.firstWord = -1
    ...
    def gotResults_39(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 128, '\'Repeat macro\' 1..9 \'times\'', e)
            self.firstWord = -1
    ...
    def get_text_actions(self, list_buffer, functional, word):
        if word == 'Paste':
            ...
            list_buffer += 'R'
        elif word == 'difference push over':
            list_buffer += 'dp'
        elif word == 'difference pull over':
            list_buffer += 'do'
        elif word == 'difference next':
            list_buffer += '\\]c'
        elif word == 'difference back':
            list_buffer += '\\[c'
        elif word == 'Format':
            list_buffer += 'Q'
    ...
    # (('Paste' | 'Paste Back' | 'Insert' | 'Append here' | 'Append' | 'Substitute' | 'Replace' | 'difference push over' | 'difference pull over' | 'difference next' | 'difference back' | 'Format' | 'Normal mode' | 'visual mode'))
    def gotResults_40(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 135, '((\'Paste\' | \'Paste Back\' | \'Insert\' | \'Append here\' | \'Append\' | \'Substitute\' | \'Replace\' | \'difference push over\' | \'difference pull over\' | \'difference next\' | \'difference back\' | \'Format\' | \'Normal mode\' | \'visual mode\'))', e)
            self.firstWord = -1
    ...
    def gotResults_41(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 171, '\'line\' <line_mod> <0to9>', e)
            self.firstWord = -1
    ...
    def gotResults_142(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 171, '\'line\' <0to9>', e)
            self.firstWord = -1
    ...
    def gotResults_42(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 172, '\'line\' <line_mod> <0to9> <0to9>', e)
            self.firstWord = -1
    ...
    def gotResults_143(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 172, '\'line\' <0to9> <0to9>', e)
            self.firstWord = -1
    ...
    def gotResults_43(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 173, '\'line\' <line_mod> <0to9> <0to9> <0to9>', e)
            self.firstWord = -1
    ...
    def gotResults_144(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 173, '\'line\' <0to9> <0to9> <0to9>', e)
            self.firstWord = -1
    ...
    def gotResults_44(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 174, '\'line\' <line_mod> <0to9> <0to9> <0to9> <0to9>', e)
            self.firstWord = -1
    ...
    def gotResults_145(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 174, '\'line\' <0to9> <0to9> <0to9> <0to9>', e)
            self.firstWord = -1
    ...
    def gotResults_45(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 186, '((\'List changes\' | \'back change\' | \'Undo jump\' | \'return from\' | \'Set mark\' | \'Goto mark\' | \'Append back\' | \'Append next\' | \'Start back\' | \'Start next\' | \'Match bracket\' | \'Scroll to bottom\' | \'Scroll bottom\' | \'Scroll to top\' | \'Scroll top\' | \'Scroll to middle\' | \'Scroll middle\'))', e)
            self.firstWord = -1
    ...
    def gotResults_46(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 187, '\'Halfpage\' (\'Up\' | \'Down\')', e)
            self.firstWord = -1
    ...
    def gotResults_149(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 187, '\'Halfpage\'', e)
            self.firstWord = -1
    ...
    def gotResults_47(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 188, '\'Page\' <top_bottom>', e)
            self.firstWord = -1
    ...
    def gotResults_48(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 193, '\'leap back\' <printable> 1..9', e)
            self.firstWord = -1
    ...
    def gotResults_150(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 193, '\'leap back\' <printable>', e)
            self.firstWord = -1
    ...
    def gotResults_49(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 194, '\'leap\' <printable> 1..9', e)
            self.firstWord = -1
    ...
    def gotResults_151(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 194, '\'leap\' <printable>', e)
            self.firstWord = -1
    ...
    def gotResults_50(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 195, '\'leap before\' <printable> 1..9', e)
            self.firstWord = -1
    ...
    def gotResults_152(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 195, '\'leap before\' <printable>', e)
            self.firstWord = -1
    ...
    def gotResults_51(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 197, '\'leap back cap\' <printable> 1..9', e)
            self.firstWord = -1
    ...
    def gotResults_153(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 197, '\'leap back cap\' <printable>', e)
            self.firstWord = -1
    ...
    def gotResults_52(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 198, '\'leap cap\' <printable> 1..9', e)
            self.firstWord = -1
    ...
    def gotResults_154(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 198, '\'leap cap\' <printable>', e)
            self.firstWord = -1
    ...
    def gotResults_53(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 199, '\'leap before cap\' <printable> 1..9', e)
            self.firstWord = -1
    ...
    def gotResults_155(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 199, '\'leap before cap\' <printable>', e)
            self.firstWord = -1
    ...
    def gotResults_54(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 200, '\'leap next\'', e)
            self.firstWord = -1
    ...
    def gotResults_55(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 202, '\'leap combo\' <printable> <printable> <printable> <printable>', e)
            self.firstWord = -1
    ...
    def gotResults_157(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 202, '\'leap combo\' <printable> <printable> <printable>', e)
            self.firstWord = -1
    ...
    def gotResults_156(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 202, '\'leap combo\' <printable> <printable>', e)
            self.firstWord = -1
    ...
    def gotResults_56(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 207, '\'Search\' <_anything>', e)
            self.firstWord = -1
    ...
    def gotResults_57(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 208, '\'Search go\' <_anything>', e)
            self.firstWord = -1
    ...
    def gotResults_58(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 209, '\'clear Search\'', e)
            self.firstWord = -1
    ...
    def gotResults_59(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 212, '\'shell command\'', e)
            self.firstWord = -1
    ...
    def gotResults_64(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 217, '\'back error\'', e)
            self.firstWord = -1
    ...
    def gotResults_65(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 218, '(\'Save\' | \'Close\' | \'save and close\') \'file\' (\'confirm\')', e)
            self.firstWord = -1
    ...
    def gotResults_158(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 218, '(\'Save\' | \'Close\' | \'save and close\') \'file\'', e)
            self.firstWord = -1
    ...
    def gotResults_66(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 222, '\'back command\' 1..9', e)
            self.firstWord = -1
    ...
    def gotResults_159(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 222, '\'back command\'', e)
            self.firstWord = -1
    ...
    def gotResults_69(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 225, '\'vim diff split\'', e)
            self.firstWord = -1
    ...
    def gotResults_70(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 232, '\'print function\'', e)
            self.firstWord = -1
    ...
    def gotResults_73(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 239, '\'Append comment\'', e)
            self.firstWord = -1
    ...
    def gotResults_75(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 243, '\'insert comment\'', e)
            self.firstWord = -1
    ...
    def gotResults_76(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 245, '(\'open\' | \'close\') \'doc string\'', e)
            self.firstWord = -1
    ...
    def gotResults_77(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 246, '\'Double slash backslash\'', e)
            self.firstWord = -1
    ...
    def gotResults_78(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 247, '\'reference\'', e)
            self.firstWord = -1
    ...
    def gotResults_79(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 248, '\'Function definition\'', e)
            self.firstWord = -1
    ...
    def gotResults_80(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 249, '\'Function definition\' <_anything>', e)
            self.firstWord = -1
    ...
    def gotResults_81(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 250, '\'Show Help\'', e)
            self.firstWord = -1
    ...
    def gotResults_82(self, words, fullResults):
        ...
        try:
            ...
            top_buffer = do_flush(False, top_buffer);
            self.firstWord += 2
            if len(words) > 2: self.gotResults_82(words[2:], fullResults)
        except Exception, e:
            handle_error('vim.vch', 251, '\'Set setting\' (\'paste\')', e)
            self.firstWord = -1
    ...
    def gotResults_160(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 251, '\'Set setting\'', e)
            self.firstWord = -1
    ...
    def gotResults_83(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 252, '\'Set dark background\'', e)
            self.firstWord = -1
    ...
    def gotResults_84(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 253, '\'Set light background\'', e)
            self.firstWord = -1
    ...
    def gotResults_85(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 254, '\'reload vim config\'', e)
            self.firstWord = -1
    ...
    def gotResults_86(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 255, '\'run this\' (\'now\')', e)
            self.firstWord = -1
    ...
    def gotResults_161(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 255, '\'run this\'', e)
            self.firstWord = -1
    ...
    def gotResults_87(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 260, '\'Split vertical\'', e)
            self.firstWord = -1
    ...
    def gotResults_88(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 262, '\'Vim Window\' <window_action>', e)
            self.firstWord = -1
    ...
    def gotResults_92(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 269, '\'via buffer\' <buffer_action>', e)
            self.firstWord = -1
    ...
    def gotResults_93(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 270, '\'via buffer number\' <1to30>', e)
            self.firstWord = -1
    ...
    def gotResults_94(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 278, '\'vim page\' <tab_actions>', e)
            self.firstWord = -1
    ...
    def gotResults_95(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 279, '\'vim page switch\' <1to30>', e)
            self.firstWord = -1
    ...
    def gotResults_96(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 284, '\'vim Tags back\'', e)
            self.firstWord = -1
    ...
    def gotResults_97(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 285, '\'vim Tags Jump\'', e)
            self.firstWord = -1
    ...
    def gotResults_98(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 286, '\'vim Tags Next\'', e)
            self.firstWord = -1
    ...
    def gotResults_99(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 287, '\'Vim Tags Match\'', e)
            self.firstWord = -1
    ...
    def gotResults_100(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 288, '\'Vim Tags Return\'', e)
            self.firstWord = -1
    ...
    def gotResults_101(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 289, '\'Vim Tags Stack\'', e)
            self.firstWord = -1
    ...
    def gotResults_102(self, words, fullResults):
        ...
        try:
            ...
            call_Dragon('Wait', 'i', [dragon_arg1])
            self.firstWord = saved_firstWord
            top_buffer += ':set nowrap{enter}'
            top_buffer = do_flush(False, top_buffer);
            self.firstWord += 1
            if len(words) > 1: self.gotResults_102(words[1:], fullResults)
        except Exception, e:
            handle_error('vim.vch', 299, '\'Nowrap\'', e)
            self.firstWord = -1
    ...
    def gotResults_103(self, words, fullResults):
        ...
        try:
            ...
            call_Dragon('Wait', 'i', [dragon_arg1])
            self.firstWord = saved_firstWord
            top_buffer += ':set paste{enter}'
            top_buffer = do_flush(False, top_buffer);
            self.firstWord += 1
            if len(words) > 1: self.gotResults_103(words[1:], fullResults)
        except Exception, e:
            handle_error('vim.vch', 300, '\'setting based\'', e)
            self.firstWord = -1
    ...
    def gotResults_104(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 301, '\'Edit vim RC\'', e)
            self.firstWord = -1
    ...
    def gotResults_105(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 302, '\'Reload\'', e)
            self.firstWord = -1
    ...
    def gotResults_106(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 303, '\'all buffers\'', e)
            self.firstWord = -1
    ...
    def gotResults_107(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 304, '\'show file details\'', e)
            self.firstWord = -1
    ...
    def gotResults_108(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 307, '\'command history\'', e)
            self.firstWord = -1
    ...
    def gotResults_109(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 308, '\'pattern match history\'', e)
            self.firstWord = -1
    ...
    def gotResults_110(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 311, '\'histogram debug\'', e)
            self.firstWord = -1
    ...
    def gotResults_111(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 312, '\'ifdef\' (\'debug\' | \'trace\')', e)
            self.firstWord = -1
    ...
    def gotResults_112(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 313, '\'ifdef end\'', e)
            self.firstWord = -1
    ...
    def gotResults_113(self, words, fullResults):
        ...
        try:
            ...
            handle_error('gvim.vcl', 7, '\'backspace\'', e)
            self.firstWord = -1
    ...
    def gotResults_114(self, words, fullResults):
        ...
        try:
            ...
            handle_error('gvim.vcl', 9, '\'File Open\'', e)
            self.firstWord = -1
    ...
    def gotResults_115(self, words, fullResults):
        ...
        try:
            ...
            handle_error('gvim.vcl', 10, '\'file save as\'', e)
            self.firstWord = -1
    ...
    def gotResults_116(self, words, fullResults):
        ...
        try:
            ...
            handle_error('gvim.vcl', 11, '\'file save\'', e)
            self.firstWord = -1
