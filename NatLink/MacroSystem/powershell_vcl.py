...
class ThisGrammar(GrammarBase):
    ...
    gramSpec = """
        ...
        <15> = 'yum' ('provides' | 'install' | 'search' | 'update' | 'remove' | 'clean' | 'clean all' | 'local install' ) ;
        <16> = 'yum list' ('available' | 'installed' | 'extras' | 'updates' | 'obsoletes' | 'all' | 'recent' ) ;
        <17> = 'yum' ('enable' | 'disable' ) 'repo' ;
