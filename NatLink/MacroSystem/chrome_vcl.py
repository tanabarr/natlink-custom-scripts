...
class ThisGrammar(GrammarBase):
    ...
    gramSpec = """
        ...
        <40> = <iml_urls> 'page' ;
        <41> = 'format jason' ;
        <42> = ('server' | 'volume' | 'alert' | 'command' | 'host' | 'job' ) 'api' ;
        <43> = 'login to Jenkins' ;
        <44> = 'Jenkins login' ;
    ...
    # ('server' | 'volume' | 'alert' | 'command' | 'host' | 'job') 'api'
    def gotResults_42(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 77, '(\'server\' | \'volume\' | \'alert\' | \'command\' | \'host\' | \'job\') \'api\'', e)
            self.firstWord = -1
    ...
    def gotResults_43(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 82, '\'login to Jenkins\'', e)
            self.firstWord = -1
    ...
    def gotResults_44(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 84, '\'Jenkins login\'', e)
            self.firstWord = -1
    ...
    def gotResults_45(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 85, '\'view full console\'', e)
            self.firstWord = -1
    ...
    def gotResults_52(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 85, '\'full console\'', e)
            self.firstWord = -1
    ...
    def gotResults_46(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 88, '\'login to get it\'', e)
            self.firstWord = -1
