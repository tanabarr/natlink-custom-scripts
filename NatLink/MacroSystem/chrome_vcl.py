...
class ThisGrammar(GrammarBase):
    ...
    def gotResults_40(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 65, '\'login to Jenkins\'', e)
            self.firstWord = -1
    ...
    def gotResults_41(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 68, '\'Jenkins login\'', e)
            self.firstWord = -1
    ...
    def gotResults_42(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 69, '\'view full console\'', e)
            self.firstWord = -1
    ...
    def gotResults_49(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 69, '\'full console\'', e)
            self.firstWord = -1
    ...
    def gotResults_43(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 72, '\'login to get it\'', e)
            self.firstWord = -1
