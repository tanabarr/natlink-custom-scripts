...
class ThisGrammar(GrammarBase):
    ...
    gramSpec = """
        ...
        <37> = 'swap focus' ;
        <38> = 'copy links' ;
        <39> = ('server' | 'server one' | 'server two' | 'command' | 'volume' | 'management' | 'filesystem' | 'filesystem one' | 'filesystem create' ) 'page' ;
        <40> = 'format jason' ;
    ...
    # ('server' | 'server one' | 'server two' | 'command' | 'volume' | 'management' | 'filesystem' | 'filesystem one' | 'filesystem create') 'page'
    def gotResults_39(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 60, '(\'server\' | \'server one\' | \'server two\' | \'command\' | \'volume\' | \'management\' | \'filesystem\' | \'filesystem one\' | \'filesystem create\') \'page\'', e)
            self.firstWord = -1
    ...
    def gotResults_40(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 61, '\'format jason\'', e)
            self.firstWord = -1
    ...
    def gotResults_41(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 69, '(\'server\' | \'volume\' | \'alert\' | \'command\' | \'host\' | \'job\') \'api\'', e)
            self.firstWord = -1
    ...
    def gotResults_42(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 74, '\'login to Jenkins\'', e)
            self.firstWord = -1
    ...
    def gotResults_43(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 76, '\'Jenkins login\'', e)
            self.firstWord = -1
    ...
    def gotResults_44(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 77, '\'view full console\'', e)
            self.firstWord = -1
    ...
    def gotResults_51(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 77, '\'full console\'', e)
            self.firstWord = -1
    ...
    def gotResults_45(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 80, '\'login to get it\'', e)
            self.firstWord = -1
