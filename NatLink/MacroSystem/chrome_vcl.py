...
class ThisGrammar(GrammarBase):
    ...
    def gotResults_43(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 77, '\'Jenkins login\'', e)
            self.firstWord = -1
    ...
    def gotResults_44(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 78, '\'view full console\'', e)
            self.firstWord = -1
    ...
    def gotResults_51(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 78, '\'full console\'', e)
            self.firstWord = -1
    ...
    def gotResults_45(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 81, '\'login to get it\'', e)
            self.firstWord = -1
