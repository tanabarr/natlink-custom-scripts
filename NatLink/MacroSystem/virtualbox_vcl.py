...
# coding: latin-1
# Generated by vcl2py 2.8.5, Mon Jul 11 14:23:50 2016
...
class ThisGrammar(GrammarBase):
    ...
    gramSpec = """
        ...
        <236> = 'skip on' ;
        <237> = ('pool' | 'she said' ) ('history' | 'status' | 'list' | 'destroy' | 'create' ) ('go' ) ;
        <319> = ('pool' | 'she said' ) ('history' | 'status' | 'list' | 'destroy' | 'create' ) ;
        <238> = 'pool' ('import' | 'export' ) ('go' ) ;
        <321> = 'pool' ('import' | 'export' ) ;
        <320> = 'pool' ('go' ) ;
        <322> = 'pool' ;
    ...
    def gotResults_237(self, words, fullResults):
        ...
        try:
            ...
            top_buffer = do_flush(False, top_buffer);
            self.firstWord += 3
            if len(words) > 3: self.gotResults_237(words[3:], fullResults)
        except Exception, e:
