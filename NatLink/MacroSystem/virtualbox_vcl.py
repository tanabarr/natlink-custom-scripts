...
# coding: latin-1
# Generated by vcl2py 2.8.5, Fri Jun 24 10:58:01 2016
...
class ThisGrammar(GrammarBase):
    ...
    gramSpec = """
        ...
        <264> = <line_actions> 'Line' ;
        <21> = 'Swap' ('Line' | 'Char' ) ;
        <22> = 'Swap back' ('Line' | 'Char' ) ;
        <23> = <edit_mode> ('Beginning' | 'Start' | 'End' ) 'Line Here' ;
        <266> = <edit_mode> ('Beginning' | 'Start' | 'End' ) 'Line' ;
        <265> = <edit_mode> ('Beginning' | 'Start' | 'End' ) 'Here' ;
        <267> = <edit_mode> ('Beginning' | 'Start' | 'End' ) ;
        <24> = 'Blank' ('back' | 'insert' ) 'Line' ;
        <268> = 'Blank' ('back' | 'insert' ) ;
        ...
        <281> = 'line' <0to9> <0to9> <0to9> ;
        <45> = 'line' <line_mod> <0to9> <0to9> <0to9> <0to9> ;
        <282> = 'line' <0to9> <0to9> <0to9> <0to9> ;
        ...
        <295> = ('Save' | 'Close' | 'save and close' ) 'file' ;
        ...
        <301> = 'line' <0to9> <0to9> <0to9> ;
        <130> = 'line' <line_mod2> <0to9> <0to9> <0to9> <0to9> ;
        <302> = 'line' <0to9> <0to9> <0to9> <0to9> ;
        ...
        <315> = 'remote login' ('root' ) ;
        <314> = 'remote login' ('cluster' ) ;
        <316> = 'remote login' ;
        <233> = 'multiple get' ;
        <234> = 'local change directory' ;
        <235> = 'local working directory' ;
        <236> = 'public key' ('15' | '11' | '12' ) ('init' | 'tool' ) ;
        <317> = 'public key' ('15' | '11' | '12' ) ;
        <237> = 'skip on' ;
        <238> = 'pool' ;
        <239> = ('pool' | 'she said' ) ('history' | 'status' | 'list' | 'destroy' | 'create' | 'import' | 'export' ) ('go' ) ;
        <318> = ('pool' | 'she said' ) ('history' | 'status' | 'list' | 'destroy' | 'create' | 'import' | 'export' ) ;
        <240> = 'pace' ('monitor' | 'resource' | 'resource resource' ) ;
        <241> = 'probe' ;
        <242> = 'check return' ;
        <243> = 'package' ('manager' | 'install' | 'remove' | 'update' | 'upgrade' ) ;
        <244> = 'find package' ;
        <245> = ('add' | 'pause' | 'reset' | 'log' | 'save' | 'clone' | 'remove' | 'stop' | 'suspend' | 'shutdown' | 'new' ) 'VM' ;
        <246> = 'open VM settings' ;
        <247> = ('start' | 'show' | 'open' ) 'VM' ;
        <248> = 'start headless' ;
        <249> = 'select a VM' ;
        <319> = 'select VM' ;
        <250> = 'VM dialogue' ('settings' | 'shutdown' ) ;
        <251> = 'new snapshot' ;
        <252> = 'ubuntu' ('minimise' | 'maximise' ) ;
        <any> = <1>|<2>|<3>|<253>|<4>|<254>|<5>|<255>|<6>|<7>|<256>|<8>|<257>|<9>|<258>|<10>|<260>|<259>|<261>|<11>|<262>|<12>|<263>|<13>|<14>|<15>|<16>|<17>|<18>|<19>|<20>|<264>|<21>|<22>|<23>|<266>|<265>|<267>|<24>|<268>|<25>|<270>|<269>|<271>|<26>|<27>|<28>|<29>|<30>|<31>|<32>|<33>|<272>|<34>|<35>|<273>|<36>|<37>|<274>|<38>|<39>|<40>|<275>|<41>|<42>|<279>|<43>|<280>|<44>|<281>|<45>|<282>|<46>|<47>|<286>|<48>|<49>|<287>|<50>|<288>|<51>|<289>|<52>|<290>|<53>|<291>|<54>|<292>|<55>|<56>|<294>|<293>|<57>|<58>|<59>|<60>|<61>|<62>|<63>|<64>|<65>|<66>|<295>|<67>|<296>|<68>|<69>|<70>|<71>|<72>|<73>|<74>|<75>|<76>|<77>|<78>|<79>|<80>|<81>|<82>|<83>|<297>|<84>|<85>|<86>|<87>|<298>|<88>|<89>|<90>|<91>|<92>|<93>|<94>|<95>|<96>|<97>|<98>|<99>|<100>|<101>|<102>|<103>|<104>|<105>|<106>|<107>|<108>|<109>|<110>|<111>|<112>|<113>|<114>|<115>|<116>|<117>|<118>|<119>|<120>|<121>|<122>|<123>|<124>|<125>|<126>|<127>|<299>|<128>|<300>|<129>|<301>|<130>|<302>|<131>|<132>|<133>|<134>|<135>|<136>|<137>|<303>|<138>|<139>|<140>|<141>|<142>|<143>|<144>|<145>|<146>|<147>|<148>|<149>|<150>|<151>|<152>|<153>|<154>|<155>|<156>|<157>|<158>|<159>|<160>|<161>|<162>|<163>|<164>|<165>|<304>|<166>|<167>|<168>|<169>|<170>|<306>|<305>|<307>|<171>|<172>|<173>|<174>|<175>|<176>|<177>|<178>|<179>|<180>|<308>|<181>|<309>|<182>|<183>|<184>|<185>|<186>|<187>|<188>|<189>|<190>|<191>|<192>|<193>|<194>|<195>|<196>|<197>|<198>|<199>|<200>|<201>|<202>|<203>|<204>|<205>|<206>|<207>|<208>|<209>|<210>|<310>|<211>|<212>|<311>|<213>|<214>|<215>|<216>|<217>|<218>|<219>|<220>|<221>|<222>|<223>|<224>|<225>|<312>|<226>|<227>|<228>|<229>|<230>|<231>|<313>|<232>|<315>|<314>|<316>|<233>|<234>|<235>|<236>|<317>|<237>|<238>|<239>|<318>|<240>|<241>|<242>|<243>|<244>|<245>|<246>|<247>|<248>|<249>|<319>|<250>|<251>|<252>;
