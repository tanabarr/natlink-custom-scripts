...
class ThisGrammar(GrammarBase):
    ...
    gramSpec = """
        ...
        <4> = 'Press' <special> <nn> ;
        <13> = (('Left' | 'Right' | 'Up' | 'Down' | 'space-bar' | 'tab-key' | 'Enter' | 'page-up' | 'page-down' | 'Backspace' | 'delete' | 'escape' ) ) <nn> ;
        <5> = 'Press' <mod> <key> <nn> ;
        <14> = ('Shift' | 'control-key' | 'Alt' ) <key> <nn> ;
        <6> = 'Press' <mod> <mod> <key> <nn> ;
        <15> = ('Shift' | 'control-key' | 'Alt' ) <mod> <key> <nn> ;
        <7> = 'Press' <mod> <mod> <mod> <key> <nn> ;
        <16> = ('Shift' | 'control-key' | 'Alt' ) <mod> <mod> <key> <nn> ;
        <8> = 'Save and Close' ;
        <9> = 'Dont Save and Close' ;
        <10> = 'Save File' ;
        <11> = 'Save As' ;
        <12> = 'Replace' ;
        <any> = <1>|<2>|<3>|<4>|<13>|<5>|<14>|<6>|<15>|<7>|<16>|<8>|<9>|<10>|<11>|<12>;
