...
# coding: latin-1
# Generated by vcl2py 2.8.5, Sun Nov 13 09:31:37 2016
...
class ThisGrammar(GrammarBase):
    ...
    gramSpec = """
        ...
        <182> = 'packet to dump' ;
        <367> = 'packet dump' ;
        <183> = 'remote login' ('root' ) ('cluster' | 'local cluster' ) ;
        <369> = 'remote login' ('root' ) ;
        <368> = 'remote login' ('cluster' | 'local cluster' ) ;
        <370> = 'remote login' ;
        <184> = 'multiple get' ;
    ...
    # 'remote login' ('root') ('cluster' | 'local cluster')
    def gotResults_183(self, words, fullResults):
        ...
        try:
            ...
            if word == 'cluster':
                top_buffer += 'lotus-vm'
                top_buffer += '{left_2}'
            elif word == 'local cluster':
                top_buffer += 'lotus-32vm'
            top_buffer = do_flush(False, top_buffer);
            self.firstWord += 3
            if len(words) > 3: self.gotResults_183(words[3:], fullResults)
        except Exception, e:
            handle_error('UNIX_shell.vch', 194, '\'remote login\' (\'root\') (\'cluster\' | \'local cluster\')', e)
            self.firstWord = -1
    ...
    # 'remote login' ('cluster' | 'local cluster')
    def gotResults_368(self, words, fullResults):
        ...
        try:
            ...
            handle_error('UNIX_shell.vch', 194, '\'remote login\' (\'cluster\' | \'local cluster\')', e)
            self.firstWord = -1
